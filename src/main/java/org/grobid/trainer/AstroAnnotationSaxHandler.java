 ...
 * Astronomical entities are inline annotations.
 * The training data for the CRF models are generated during the XML parsing.
 *
 * @author Patrice
 */
public class AstroAnnotationSaxHandler extends DefaultHandler {
    ...
    public AstroAnnotationSaxHandler() {
    }
